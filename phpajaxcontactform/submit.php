...
if(1)
{
	...
	*/
    ...
    $user_name		= "rahul123";//filter_var($_POST["user_name"], FILTER_SANITIZE_STRING);
    $user_email		= "rhlthrt2000@gmail.com";//filter_var($_POST["user_email"], FILTER_SANITIZE_EMAIL);
    $phone_number	= "9561071879";  // filter_var($_POST["phone_number"], FILTER_SANITIZE_NUMBER_INT);
    $subject		= "aaaaaaaaa"; // filter_var($_POST["subject"], FILTER_SANITIZE_STRING);
    $message		= "BBBBB"; // filter_var($_POST["message"], FILTER_SANITIZE_STRING);
    $captcha_answer	= "123"; // filter_var($_POST["captcha_answer"], FILTER_SANITIZE_STRING);
	...
	*/
    ...
    if(_IS_SMTP === TRUE){
        $send_mail = send_smtp_email($user_email, $subject, $message_body);
    }else{
        $send_mail = send_normal_email($user_email, $subject, $message_body, $cc="", $bcc="");
    }
